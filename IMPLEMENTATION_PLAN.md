...
**Related docs:** `NUMCHESS_DESIGN_DOCUMENT.md` (game design), `adr/*.md` (decisions), `docs/RULES.md`, [docs/UI_ELITE_IMPLEMENTATION_PLAN.md](docs/UI_ELITE_IMPLEMENTATION_PLAN.md) (Phase 3b), [docs/LIVE_SCORING_AND_AUDIO_PLAN.md](docs/LIVE_SCORING_AND_AUDIO_PLAN.md), [docs/SPLIT_DIAGONALS_AND_LIVE_SCORING_V2_PLAN.md](docs/SPLIT_DIAGONALS_AND_LIVE_SCORING_V2_PLAN.md) (split ↘/↙ + dynamic live score), [docs/BOT_AI_IMPROVEMENT_PLAN.md](docs/BOT_AI_IMPROVEMENT_PLAN.md) (Phase 6b — eval aligned with live score, ordering, TT, sims), [docs/BOT_SEARCH_REVAMP_V3_PLAN.md](docs/BOT_SEARCH_REVAMP_V3_PLAN.md) (**v3** — fast + sharp search: global clock, top-K, tactical pruning), [docs/VS_BOT_MODE_FIX_PLAN.md](docs/VS_BOT_MODE_FIX_PLAN.md) (Vs bot reliability, input gating, worker hardening), [docs/BOT_VS_STALL_AND_1_2_0_PLAN.md](docs/BOT_VS_STALL_AND_1_2_0_PLAN.md) (**P0** stall on bot turn + bot AI for rules 1.2.0), [docs/FLANKING_DIAGONALS_1_2_0_PLAN.md](docs/FLANKING_DIAGONALS_1_2_0_PLAN.md) (rules 1.2.0 — 5-cell flanking diagonals).
